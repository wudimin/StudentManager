    ...
    <script type="text/javascript">
        $(function(){
            ...
            $("#vcodeImg").click(function(){
                this.src="get_cpacha?vl=4&w=153&h=40&t="+new Date().getTime();
            });
        ...
        <form id="form" class="form form-horizontal" method="post">
            ...
            <div class="row cl">
                <div class="formControls col-8 col-offset-3">
                    ...
                    <img title="点击图片切换验证码" id="vcodeImg" src="get_cpacha?vl=4&w=153&h=40"></div>
            </div>
...
<div class="footer">Copyright &nbsp; 信息工程学院 @ 张子敏 </div>
