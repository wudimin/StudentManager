...
<div id="toolbar">
    ...
    <div><a id="delete" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-some-delete',plain:true">删除</a>
        用户名：<input id="search-username" class="easyui-textbox" name="search-username" />
    ...
    <form id="editForm" method="post">
        ...
        <table id="editTable" border=0 cellpadding="6" >
            <tr>
                <td>用户名:</td>
                <td colspan="3">
                    <input id="edit_username"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="username" data-options="required:true, validType:'repeat', missingMessage:'请输入用户名'" />
                </td>
                <td style="width:80px"></td>
            </tr>
            <tr>
